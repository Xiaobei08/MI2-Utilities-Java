...
import mi2u.ui.BuildingInventory;
            ...
            if(mi2ui.settings.getBool("enUnitPath")){
                if(unit.isCommandable() && unit.controller() instanceof CommandAI ai && ai.targetPos != null){
                    ...
                    for(int tileIndex = 1; tileIndex <= max; tileIndex++){
                        Tile nextTile = pathfinder.getTargetTile(tile, pathfinder.getField(unit.team, unit.dockedType.flowfieldPathType, Pathfinder.fieldCore));
